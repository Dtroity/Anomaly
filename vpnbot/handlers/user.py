...
async def callback_help(callback: CallbackQuery):
    ...
    help_text = (
        ...
        f"💻 Рекомендуемые клиенты (бесплатные):\n"
        f"• Android: <a href=\"https://github.com/2dust/v2rayNG/releases\">v2rayNG</a> (2dust)\n"
        f"• iOS: <a href=\"https://apps.apple.com/app/v2raytun/id6446814690\">V2RayTun</a> (App Store)\n"
        f"• Windows: <a href=\"https://github.com/2dust/v2rayN/releases\">v2rayN</a> (2dust)\n"
        f"• macOS: <a href=\"https://github.com/2dust/v2rayN/releases\">v2rayN</a> (2dust)\n"
        f"• Linux: <a href=\"https://github.com/v2rayA/v2rayA/releases\">v2rayA</a> (v2rayA)\n\n"
